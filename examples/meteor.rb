# Modified version of https://raw.github.com/jruby/jruby/master/bench/shootout/meteor.ruby
# See bottom for profiling setup
...
profile = JRuby::Profiler.profile do
  Processor.new.find_all
end

File.open(File.expand_path('../meteor.gv', __FILE__), 'w') do |io|
